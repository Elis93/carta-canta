...
export const VOCI_APP: VoceApp[] = [
  ...
  { label: 'Vetrina', dove: 'Altro › Andamento', href: '/farti-trovare',
    desc: 'La tua vetrina pubblica e le richieste che arrivano',
    parole: ['vetrina', 'profilo pubblico', 'farmi trovare', 'fatti trovare', 'nuovi clienti', 'richieste', 'pubblicità'] },
  { label: 'Recensioni', dove: 'Altro › Strumenti', href: '/recensioni',
    parole: ['recensioni', 'recensione', 'stelle', 'feedback', 'giudizi'] },

  // ── Impostazioni ───────────────────────────────────────────────────────
  { label: 'Dati dell’attività', dove: 'Impostazioni › Dati dell’attività', href: '/impostazioni/generale',
    desc: 'Ragione sociale, indirizzo, telefono, logo',
    parole: ['ragione sociale', 'indirizzo', 'telefono', 'logo', 'dati attività', 'nome ditta'] },
  { label: 'Preavviso delle scadenze', dove: 'Impostazioni › Dati dell’attività', href: '/impostazioni/generale',
  ...
  { label: 'Impostazioni fiscali', dove: 'Impostazioni › Fiscale', href: '/impostazioni/fiscale',
  ...
  { label: 'Come farti pagare', dove: 'Impostazioni › Pagamenti', href: '/impostazioni/pagamenti',
    desc: 'IBAN e istruzioni di pagamento sui documenti',
    parole: ['iban', 'bonifico', 'coordinate', 'come mi pagano', 'pagamento', 'banca', 'conto'] },
  { label: 'Notifiche', dove: 'Impostazioni › Notifiche', href: '/impostazioni/notifiche',
  ...
  { label: 'Esci da tutti i dispositivi', dove: 'Account › Sicurezza e blocco app', href: '/account/sicurezza',
    parole: ['esci', 'logout', 'ho perso il telefono', 'chiudere sessioni', 'accessi'] },
  { label: 'Scarica i tuoi dati', dove: 'Account › I tuoi dati', href: '/account/dati',
    parole: ['scarica dati', 'esporta', 'backup', 'i miei dati', 'copia'] },
  { label: 'Il tuo commercialista', dove: 'Account › I tuoi dati', href: '/account/dati',
    desc: 'Pacchetto da mandargli e accesso in sola lettura',
    parole: ['commercialista', 'studio', 'contabile', 'registro fatture', 'csv'] },
  { label: 'Elimina account', dove: 'Account e abbonamento', href: '/account',
    parole: ['elimina account', 'cancellare account', 'chiudere account', 'disdire'] },

  // ── Il resto ───────────────────────────────────────────────────────────
  { label: 'Cestino', dove: 'Preventivi, Fatture e Sopralluoghi', href: '/cestino',
    desc: 'Preventivi, fatture e sopralluoghi eliminati, recuperabili per 15 giorni',
    parole: ['cestino', 'cancellato', 'eliminato', 'buttato', 'recuperare', 'ripristinare', 'per sbaglio', 'sopralluogo'] },
