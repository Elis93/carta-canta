...
export const VOCI_APP: VoceApp[] = [
  ...
  { label: 'Blocco dell’app', dove: 'Account e sicurezza › Sicurezza', href: '/account/sicurezza',
    desc: 'Impronta o volto per aprire l’app',
    parole: ['impronta', 'blocco', 'bloccare app', 'password app', 'volto', 'faccia', 'sicurezza', 'proteggere'] },
  { label: 'Esci da tutti i dispositivi', dove: 'Account e sicurezza › Sicurezza', href: '/account/sicurezza',
    parole: ['esci', 'logout', 'ho perso il telefono', 'chiudere sessioni', 'accessi'] },
  { label: 'Scarica i tuoi dati', dove: 'Account e sicurezza › Dati', href: '/account/dati',
    parole: ['scarica dati', 'esporta', 'backup', 'i miei dati', 'copia'] },
  { label: 'Il tuo commercialista', dove: 'Account e sicurezza › Dati', href: '/account/dati',
