...
export interface PagamentoFallitoEmailProps {
  workspaceName: string
  planName: string
  portalUrl: string
}

export function PagamentoFallitoEmail({
  workspaceName,
  planName,
  portalUrl,
}: PagamentoFallitoEmailProps) {
  return (
    <Html lang="it">
      <Head />
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Heading style={h1}>Pagamento non riuscito</Heading>
            <Text style={paragraph}>
              Ciao <strong>{workspaceName}</strong>,
            </Text>
            <Text style={paragraph}>
              Non siamo riusciti ad addebitare il rinnovo del tuo piano{' '}
              <strong>{planName}</strong>. Il tuo accesso alle funzionalità Pro
              potrebbe essere limitato se il problema non viene risolto.
            </Text>
            <Text style={paragraph}>
              Aggiorna il tuo metodo di pagamento dal portale per mantenere
              il piano attivo:
            </Text>
            ...
            <Text style={footer}>
              ...
              In caso di problemi contattaci a supporto@cartacanta.app.
            </Text>
          </Section>
        </Container>
      </Body>
...
const button: React.CSSProperties = {
  backgroundColor: '#dc2626', color: '#ffffff', padding: '12px 28px',
