...
export const CRON_JOBS: { name: string; label: string; maxAgeHours: number }[] = [
  // ⚠️ Il cron `sdi-auto` (pilota +24h) è stato RITIRATO con la Fase 1 della
  // copia di cortesia (21 set 2026): la trasmissione SdI è un gesto esplicito,
  // niente più trasmissioni programmate da sorvegliare.
