...
export async function updateWorkspaceFiscal(
  ...
  // ⚠️ Il blocco «sdi_auto_enabled» (pilota +24h) è stato ritirato con la
  // Fase 1 della copia di cortesia (21 set): l'interruttore non esiste più
  // in UI e la colonna resta dormiente.
...
const NotificationPrefsSchema = z.object({
  ...
  // Listino fornitore scaduto usato da un preventivo ancora aperto (15 ago, fase 3)
  inapp_listino_scaduto: z.boolean().default(true),
