...
- ⚠️ **Ancora da confermare (2 punti minori)**: ① le **fatture** non consumano la quota degli 8 (il limite è solo sui preventivi) → su Free restano aperte anche le fatture #9+? (proposta: sì, il limite è sui preventivi); ② un preventivo BLOCCATO resta **solo lettura** (si apre e si legge) ma non modificabile/inviabile — confermare che «visibile» = apribile in lettura, non solo una riga in lista.
