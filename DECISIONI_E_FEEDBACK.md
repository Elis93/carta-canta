...
- ✅ **Agenda a CALENDARIO mensile** (19 lug): i giorni del mese come un calendario, pallino oro sui giorni con appuntamenti, tocchi un giorno e vedi cosa c'è (ora/con chi/dove), tocchi l'appuntamento e si apre. Default = oggi. Naviga per mese. 🔁 Supera la lista settimanale precedente. ⏳ Follow-up: avviso "quel giorno hai già X" in fase di creazione appuntamento.
