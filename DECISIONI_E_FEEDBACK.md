...
### Collaudo Eli 17–18 lug 2026 (PR #121–#132 — verificate il 18 lug sera con ri-review a 2 agent)
...
- ✅ **Preventivi con più proposte — resa al cliente**: nel PDF/"documento completo" le voci sono RAGGRUPPATE per proposta con "PROPOSTA BASE/PREMIUM (★) — Totale X €" e nota che il riepilogo si riferisce alla prima proposta; riepilogo in-app etichettato; pagina pubblica "Totale proposta Base". Mai più liste appiattite con totale scollegato.
