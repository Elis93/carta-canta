...
- ✅ **Trova professionista: ricerca per parola parziale** (19 lug): basta una parte della professione o di un servizio (es. "serbatoi" trova "pulizie dei serbatoi") — cerca ogni parola digitata dentro mestiere, presentazione e nome. Nel form marketplace il campo è ora "Mestiere e servizi" con l'invito a elencare i servizi. ⏳ Geolocalizzazione "nei dintorni" con allargamento fino a 5: richiede coordinate sui profili (geocoder) — vedi backlog.
