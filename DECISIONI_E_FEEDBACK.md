...
- ⏸️ **Proposta lasciata sul tavolo, non decisa**: la cancellazione automatica dopo 15 giorni potrebbe non toccare mai una fattura **già inviata al cliente** (solo le bozze), così una fattura emessa altrove resta comunque recuperabile e a distruggerla può essere solo un «elimina per sempre» esplicito. Cambia una promessa del testo del cestino → serve l'ok di Eli.
