...
| T25 | (**Fase 2 acconti**, sandbox SdI) Con un acconto fatturato: ① prova «**Converti in fattura**» sul preventivo → deve essere BLOCCATO («conterebbe due volte la parte già fatturata»); ② trasmetti la ACC dallo SdI e simula «Consegnata» | ① Blocco con messaggio onesto (il saldo a conguaglio è la Fase 3); ② la ACC si trasmette come una fattura (XML **TD02**), all'esito positivo parte la copia di cortesia al cliente («Fattura di acconto … da …») e la ACC diventa Inviata ✅ SUPERATO (26 set, al secondo giro: il primo si era fermato sul «—» della descrizione, fuori dai caratteri ammessi — corretto) · **T25-bis**: nuova ACC su un preventivo con un **bene significativo** → scarica l'XML: deve avere una o più righe `<Causale>` con «Beni significativi … quota di …» |
