...
>
> **🔴 COLLAUDO SANDBOX IN CORSO (copia di cortesia, Fasi 1-2) — riprendi da qui:**
> Ambiente già pronto: `NEXT_PUBLIC_SDI_ENABLED=true`, chiave OpenAPI sandbox, migration 089 applicata.
> · ✅ Superati: **T15** (copia automatica), **T16** (cliente senza email), **T21** (scarto post-copia).
> · ⏳ Restano: **T14** · **T17** · **T18** · **T19** · **T20** — sono nella tabella della sezione A-bis, in fondo.
> Ordine consigliato: T14 (5 min, solo da guardare) → T17 (5 min) → T20 (10 min, la spunta della Fase 2) → T18 (10 min, l'acconto) → T19 (10 min, la nota di credito).
> ⚠️ Usa fatture usa-e-getta su un account di prova: una fattura trasmessa in sandbox si blocca come una vera e non si elimina.
>
