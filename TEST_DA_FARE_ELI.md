...
| T28 | (**Preventivo con fattura collegata**) Su un preventivo che ha una fattura di acconto (anche NON trasmessa) apri ⋯ → Elimina, poi scendi in fondo alla pagina; ripeti dal menu ⋯ della riga nella lista Preventivi | Il tasto **Elimina è spento** ovunque e sotto dice «Preventivo non eliminabile: da qui è nata la fattura di acconto ACC …, che resta legata a questo preventivo. Per toglierlo dalla lista, usa «Archivia».» → **Archivia** funziona. Poi elimina la fattura di acconto (non trasmessa): il preventivo torna eliminabile |
