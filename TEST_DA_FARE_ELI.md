...
| T24 | (**Fase 2 acconti**, correzione) Sulla fattura di acconto appena creata (NON trasmessa) tocca **Elimina** | Il dialog avvisa che «l'acconto registrato sul preventivo viene azzerato»; confermando, la ACC va nel cestino e sul preventivo l'acconto torna «**da ricevere**» — si può registrare di nuovo con la cifra giusta |
