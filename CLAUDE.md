...
**Verifica prima di ogni rilascio:** `npx tsc --noEmit` · `npm run build` · `npm test` (604) · `npm run build && npm run smoke:public` (20 check) · `npm run security:check` (sito vero).
