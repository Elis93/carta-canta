...
### ⚠️ Migration 069 e 070 DA APPLICARE (5 ago, in quest'ordine, DOPO il deploy del codice)
- **069** — chiude la lettura pubblica delle foto rimasta aperta dalla 041 (la 068 da sola non bastava). Validata su PG16.
- **070** — le coordinate di pagamento si cambiano solo dal server (anti-frode BEC). ⚠️ Va applicata DOPO il deploy: prima, il salvataggio dei pagamenti risponderebbe "non riuscito". Validata su PG16.
### Migration: 047-068 TUTTE APPLICATE (✅ 068 applicata da Eli il 5 ago: foto in archivio privato)
### Migration: 047-063 (storico) TUTTE APPLICATE (✅ 063 applicata da Eli il 2 ago: listini fornitori)
### Migration: 047-062 (storico) TUTTE APPLICATE (✅ 062 applicata da Eli il 2 ago: unit_cost + convert col costo)
### Migration: 047-061 (storico) TUTTE APPLICATE (✅ 061 applicata da Eli il 26 lug: deduplica Stripe a due fasi)
