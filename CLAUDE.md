...
**001-075 TUTTE APPLICATE. ⚠️ La 076 è DA APPLICARE** («la richiesta ricorda il preventivo che ne è nato»: `marketplace_requests.document_id` + GRANT per colonna, validata su PG16). Senza, il collegamento non si scrive e la richiesta resta com'era: nessun danno, solo la funzione che non parte.
