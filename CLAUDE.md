...
- **⚠️ PATTERN CATALOGATO, NON CHIUSO**: la stessa chiamata senza try/catch esiste in **54 punti** (elenco riproducibile con lo script dell'handoff). Ho sistemato solo quelli dove si perde lavoro scritto; gli altri (elimina, duplica, imposta predefinito…) al massimo fanno perdere un click. Da valutare se convertirli tutti con un helper condiviso.
...
- tsc+build+**327/327** verdi · scan spazi pulito.
