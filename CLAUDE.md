...
- ⚠️ **Nota**: `types/database.ts` va rigenerato dopo la 073 (regola B.1.6) — nel frattempo quell'UPDATE passa da un client non tipizzato.
...
### Stato migration (aggiornato 7 ago 2026)
⚠️ **073 DA APPLICARE** (`073_giorni_preavviso_scadenza.sql` — preavviso della card «In scadenza», validata su PG16). Subito dopo: **rigenerare `types/database.ts`** (B.1.6). Finché non è applicata l'app funziona: il preavviso vale 10 giorni e il salvataggio delle impostazioni ripiega senza quel campo.
