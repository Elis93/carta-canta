...
### ✅ 25 lug — 4 SCELTE PRODOTTO di Eli (via AskUserQuestion) IMPLEMENTATE (⚠️ migration 058 DA APPLICARE)
...
### Migration: 047-057 tutte APPLICATE (054 misure sopralluogo: 18 lug; 055 marketplace lat/lng "Vicino a me": 19 lug; **056 passkeys "sblocco con impronta": applicata da Eli il 20 lug**; **057 sicurezza prove/quota sdi_usage: applicata da Eli il 25 lug**). Test: tsc verde · build verde · **280/280** verdi. Smoke pubblico: `npm run build && npm run smoke:public` (20 check).
