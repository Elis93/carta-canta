...
- ⚠️ **Residuo dichiarato**: il menu ⋯ delle liste offre ancora «Duplica» sui bloccati → tocco = toast d'errore (server rifiuta), non un badge; innocuo, in beta zero impatto. **⑥ chiusa in (24)** → il piano downgrade è COMPLETO.
...
**001-083 applicate (081 e 082 applicate da Eli il 12 ago; 083 applicata da Eli il 14 ago).**
