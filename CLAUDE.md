...
**001-075 TUTTE APPLICATE, per intero.** La 075 («Archivio dei documenti + solleciti spenti»: `documents.archived_at` e `documents.reminders_off_at`) è stata applicata da Eli l'8 ago, subito dopo il deploy; la 074 («Posticipa il sollecito») lo stesso giorno. Entrambe validate su PG16 prima della consegna.
