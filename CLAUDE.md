...
**001-078 applicate (la 078 l'ha applicata Eli il 10 ago).**
...
**Verifica prima di ogni rilascio:** `npx tsc --noEmit` · `npm run build` · `npm test` (588) · `npm run build && npm run smoke:public` (20 check) · `npm run security:check` (sito vero).
