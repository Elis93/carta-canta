...
### ✅ 10 ago (6) — CONTROLLO GENERALE DI BUG (2 revisori paralleli sul diff 8→10 ago): 3 ALTE + 7 MEDIE, tutte chiuse (⚠️ migration 078)
...
**001-077 applicate (la 077 l'ha applicata Eli il 9 ago). ⚠️ La 078 è DA APPLICARE.**
...
**Verifica prima di ogni rilascio:** `npx tsc --noEmit` · `npm run build` · `npm test` (586) · `npm run build && npm run smoke:public` (20 check) · `npm run security:check` (sito vero).
