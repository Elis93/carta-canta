...
> **Ultima sessione: 10 agosto 2026** (multi-nota di credito col tetto «mai oltre il totale della fattura», via il Regime dei Minimi, audit NC+IVA sulle fonti).
...
### Stato migration (aggiornato 10 ago 2026)
**001-078 applicate (la 078 l'ha applicata Eli il 10 ago). ⚠️ La 079 è DA APPLICARE.**
...
**Verifica prima di ogni rilascio:** `npx tsc --noEmit` · `npm run build` · `npm test` (601) · `npm run build && npm run smoke:public` (20 check) · `npm run security:check` (sito vero).
