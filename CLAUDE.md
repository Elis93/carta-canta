...
- ⚠️ **Cosa NON c'è ancora, ed è deliberato**: la **trasmissione allo SdI** della nota (l'XML oggi rifiuta perfino le fatture con sconto), l'inclusione nel **registro fatture** e nell'**export CSV**, e lo storno parziale guidato. Sono il prossimo pezzo, e il registro va fatto insieme al commercialista.
...
### Stato migration (aggiornato 8 ago 2026)
**001-076 TUTTE APPLICATE.** La 076 («la richiesta ricorda il preventivo») è stata applicata da Eli l'8 ago.
