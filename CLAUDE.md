...
- **FIX**: dopo aver usato **Copia link / WhatsApp / Altre app** su un documento in quello stato, il pop-up **resta aperto** e chiede *«Hai mandato tu il preventivo al cliente? Lo segno come reinviato e tolgo l'avviso «Modificato». La scadenza ripartirà da oggi (30 giorni)»* → **Sì, l'ho mandato** / **Non ancora**. ⚠️ Prima il pop-up si chiudeva PRIMA di aprire il canale: ora si chiude solo quando non c'è niente da chiedere, così tornando da WhatsApp si trova la domanda.
...
**001-074 TUTTE APPLICATE, per intero.** La 074 («Posticipa il sollecito») è stata applicata da Eli l'8 ago, dopo la validazione su PG16.
