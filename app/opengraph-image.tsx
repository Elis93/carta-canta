...
// Card Open Graph di DEFAULT per tutta l'app (login, pagine interne, landing):
// logo "firma" centrato su sfondo crema. Le route con un proprio opengraph-image
// (es. app/p/[token]) la sovrascrivono.
...
export default async function OpengraphImage() {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* logo 900×210 → larghezza 1000, altezza proporzionale 233 */}
