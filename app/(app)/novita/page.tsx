...
const NOVITA: Array<{ data: string; titolo: string; punti: string[] }> = [
  ...
  },
  {
    ...
    punti: [
      ...
      'Invita il tuo commercialista (Impostazioni › Dati): con la sua email accede a fatture, incassi e spese in sola lettura e scarica registro e bilancio da solo. Revocabile quando vuoi.',
