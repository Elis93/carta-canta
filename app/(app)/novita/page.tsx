...
const NOVITA: Array<{ data: string; titolo: string; punti: string[] }> = [
  {
    ...
    punti: [
      ...
      'Guide delle sezioni: la prima volta che entri in «Altro» o nel «Bilancio» si apre un breve giro guidato che ti spiega cosa c’è. Dura pochi secondi, si chiude quando vuoi e non ricompare più. Le rivedi tutte da Altro › Account e dati, insieme al tutorial di primo accesso.',
  ...
  },
  {
    ...
    punti: [
      ...
      'Pacchetto per il commercialista: da Fatture (o da Altro › Account e dati) scarichi il registro delle fatture del periodo — con imponibile, IVA, bollo e incassato — pronto da girare allo studio.',
      'Invita il tuo commercialista (Altro › Account e dati): con la sua email accede a fatture, incassi e spese in sola lettura e scarica registro e bilancio da solo. Revocabile quando vuoi.',
      ...
      '"Scarica i tuoi dati" in Altro › Account e dati: tutti i tuoi dati in un file.',
