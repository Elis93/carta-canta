...
const NOVITA: Array<{ data: string; titolo: string; punti: string[] }> = [
  ...
  },
  {
    ...
    punti: [
      ...
      'Testo grande: in Altro › Strumenti c’è un interruttore che ingrandisce scritte e pulsanti in tutta l’app e aggiunge una spiegazione sotto le voci dei menu. Se non lo attivi, non cambia nulla.',
