...
const NOVITA: Array<{ data: string; titolo: string; punti: string[] }> = [
  {
    ...
    punti: [
      'La lista dei sopralluoghi non usa più i cerchi con le sigle («GG», «S2»): ogni riga dice il cliente e l’indirizzo del cantiere, con il numero di foto a destra, poi l’appuntamento e l’ultimo aggiornamento, e in fondo lo stato in parole («Preventivo 012/2026 creato» in verde, «Da trasformare in preventivo» in grigio). Il filetto a sinistra è verde se il preventivo c’è già, oro se ci sono foto da lavorare, grigio se sono solo appunti.',
