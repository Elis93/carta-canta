  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div style={{ background: '#1a1a2e', color: '#f2ecdd', padding: '12px 15px 16px', position: 'relative', overflow: 'hidden' }}>
        ...
        {/* La riga «Da concludere entro il {data}» è stata TOLTA (decisione Eli
            9 set): la data calcolata dall'accettazione non si mostra mai da
            sola — andrà confermata dall'artigiano (flusso futuro). */}
      </div>
      ...
      <div style={{ padding: '12px 15px 20px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        {/* ── Stato e dettagli + Prossimo intervento: DUE card rese dallo
            stesso componente (stato e auto-save condivisi) — il Prossimo
            intervento è una sezione bianca a sé dal 9 set (mockup Eli) ── */}
