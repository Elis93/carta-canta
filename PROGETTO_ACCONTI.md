...
| **Risoluzione 42/E del 9 aprile 2019** (letta) | Codici tributo F24 2521-2526 (validi). ⚠️ Il termine che cita — «entro il 20 del primo mese successivo» — è **SUPERATO** (verifica web 26 set 2026): oggi il bollo si paga entro **31 maggio · 30 settembre · 30 novembre · fine febbraio**, con accorpamento se sotto 5.000 €. L'app non cita questi termini |
...
| **Controllo incrociato del 26 set 2026** sulle domande aperte al commercialista (ricerca web + PDF già letti; siti AdE/Normattiva/AgID bloccati dal proxy → fonti ufficiali spesso solo da snippet) | Esiti in `COSE_DA_FARE_ELI.md`, riquadro in testa alle N. Per la Fase 3: TD02 del condominio **con** ritenuta (N25 ②) · una TD02 si rettifica con TD04 o TD08 (Guida compilazione **1.10, aprile 2025**) · la guida bollo **giugno 2026** (letta) conferma che le N6.x sono fuori dal calcolo del bollo · SAL: ancora nessuna fonte ufficiale. Su `TipoRitenuta` per snc/sas e `ImportoTotaleDocumento` con ritenuta la ricerca rifatta la sera stessa ha trovato **fonti discordanti** — ⚠️ corretto la sera dopo aver LETTO i PDF: l'esempio dell'Università di Ferrara mette `ImportoTotaleDocumento` al **lordo** della ritenuta (imponibile + IVA) e il netto in `DatiPagamento`, cioè il contrario dell'app; nessuna correzione senza l'ok di Eli, restano domande al commercialista · forfettario committente in reverse charge: versamento **trimestrale** dal 1° ott 2025 (D.Lgs. 81/2025) |
| **PDF letti la sera del 26 set 2026** (scaricati da Eli: istruzioni CU 2026, Redditi PF 2026 fasc. 3, ris. 47/E/2013, circ. 14/E e 37/E del 2015, Allegato 3 Unife, Guida 1.10 + testo di due FAQ AdE) | CausalePagamento **W** confermata dalle istruzioni CU · `ImportoTotaleDocumento` al **lordo** nell'esempio Unife (N15 ③) · contratto misto in reverse charge: si **scompone**, salvo costruzione/restauro/ristrutturazione/frazionamento → tutto ordinario (N16) · criterio **cessione con posa vs appalto** = causa del contratto (37/E/2015 §3), utile per il 4% del condominio sulla caldaia (N25 ③) · beni significativi **non** si applicano in reverse charge (37/E/2015 §13) · privato estero senza CF: XXXXXXX, IdPaese + IdCodice, CF vuoto (N21 ②) · rigo **RS40** «ritenute regime forfetario» nel modello 2026 (N10) · ⚠️ la guida bollo giugno 2026 distingue il bollo delle fatture elettroniche (art. 6 DM 17/06/2014) dal «bollo virtuale» dell'art. 15 DPR 642/72 che la nostra dicitura cita (N27). Nessun codice cambiato: le proposte aspettano l'ok di Eli |
